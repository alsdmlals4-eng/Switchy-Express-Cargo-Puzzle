...
CURRENT_ADAPTER_PR_BASE = "9c3be67cf99221d5007f0332be6935e81a6954bb"
...
class PostMergeCanonFreshnessTests(unittest.TestCase):
    def test_active_canon_routes_current_decision_and_preserves_pr83_history(self) -> None:
        ...
        self.assertIn(
            ...
            "CORE_BOARD_V04_CENTERED_PORT_RAIL_CROPS_MERGED_MAIN_VERIFIED_PR_255_MAIN_2CF7BB5 · "
            ...
            "REMOTE_RUNTIME_BYTE_CI_7_GREEN_PR_255_F00DE19 · "
        ...
        self.assertIn(
            "post_sx_dec_060_candidate_status: SX60-POC-ACCEPT-010 · "
            "PREPARED_PACKAGE_VERIFIED · SX60-POC-ACCEPT-009_historical_after_SX_DEC_069",
            active,
        )
        self.assertIn(
