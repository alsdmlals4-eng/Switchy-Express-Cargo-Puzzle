...
class PostMergeCanonFreshnessTests(unittest.TestCase):
    def test_active_canon_routes_sx_dec_060_and_preserves_pr83_history(self) -> None:
        ...
        self.assertIn("sx_dec_060_runtime_implementation: IMPLEMENTED_AUTOMATED · PR_PENDING", active)
        self.assertIn("sx_dec_060_automated_regression: PASS · 111_CASES_13461_ASSERTIONS · PR_PENDING", active)
