...
const TEST_SCRIPTS: Array[Script] = [
	preload("res://tests/route_book/test_route_book_03_copy.gd"),
	preload("res://tests/route_book/test_route_book_03_witnesses.gd"),
	preload("res://tests/demo/test_hud_status_locales.gd"),
	preload("res://tests/demo/test_route_book_result_truth.gd"),
	preload("res://tests/demo/test_stage_board_preview.gd"),
	preload("res://tests/demo/test_route_book_context.gd"),
	preload("res://tests/demo/test_build_guidance.gd"),
	preload("res://tests/demo/test_build_history_ui.gd"),
	preload("res://tests/finite/integration/test_build_edit_history.gd"),
	preload("res://tests/demo/test_cargo_pickup_animation.gd"),
	preload("res://tests/demo/test_product_shell_art.gd"),
	...
	preload("res://tests/finite/presentation/test_sx_dec_059_result_summary.gd"),
	...
	preload("res://tests/first_session/test_first_session_definition.gd"),
	preload("res://tests/first_session/test_first_session_stage_policy.gd"),
	preload("res://tests/first_session/test_first_session_copy.gd"),
	preload("res://tests/first_session/test_first_session_director.gd"),
	...
	preload("res://tests/route_book/test_route_book_catalog.gd"),
	preload("res://tests/route_book/test_route_book_copy.gd"),
	preload("res://tests/route_book/test_route_book_02_copy.gd"),
	preload("res://tests/route_book/test_route_book_maps.gd"),
	preload("res://tests/route_book/test_route_book_machine_witnesses.gd"),
	...
	preload("res://tests/demo/test_first_session_end_to_end.gd"),
	preload("res://tests/demo/test_first_session_responsive_accessibility.gd"),
	preload("res://tests/demo/test_route_book_flow.gd"),
	preload("res://tests/demo/test_route_book_responsive_layout.gd"),
	...
	preload("res://tests/demo/test_product_board_route_clarity.gd"),
	preload("res://tests/demo/test_product_board_ghost.gd"),
	preload("res://tests/demo/test_product_hud.gd"),
	preload("res://tests/demo/test_playable_poc_visual_integration.gd"),
	...
	preload("res://tests/demo/test_runtime_export_data_contract.gd"),
