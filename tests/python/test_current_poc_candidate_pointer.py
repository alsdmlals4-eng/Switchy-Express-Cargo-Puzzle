...
class CandidatePointerBoundaryTests(unittest.TestCase):
    ...
    def test_post_060_pointer_selects_candidate_010_and_preserves_every_prior_exact_candidate(self) -> None:
        ...
        self.assertEqual(pointer["artifact_evidence_owner"], "evidence/acceptance/sx60_poc_accept_010_artifact.json")
        self.assertEqual(pointer["deep_pck_evidence_owner"], "evidence/acceptance/sx60_poc_accept_010_pck_deep_audit.json")
        ...
        self.assertEqual(candidate_008_history["candidate_id"], "SX60-POC-ACCEPT-008")
        self.assertEqual(candidate_008_history["source_main"], "53e29f874bc70a0057c310d661dc45dbecc6cf13")
        self.assertEqual(candidate_008_history["invalidated_by_product_source_main"], "1ac3099d9ab1451323cca2935547f82d210b50b4")
        candidate_009_history = pointer["historical_superseded_after_sx_dec_069"]
        self.assertEqual(candidate_009_history["candidate_id"], "SX60-POC-ACCEPT-009")
        self.assertEqual(candidate_009_history["source_main"], "1ac3099d9ab1451323cca2935547f82d210b50b4")
        self.assertEqual(candidate_009_history["invalidated_by_product_source_main"], "79323ff0175b674c594d18dfd6d28a8e9951f5bd")
    ...
    def test_post_060_pointer_records_machine_validation_and_final_review_boundary(self) -> None:
        ...
        self.assertIn(
            "GitHub Actions Windows Demo Export PASS · run 33415291733 · exact SX-DEC-069 source 79323ff0175b674c594d18dfd6d28a8e9951f5bd",
            pointer["completed_machine_gates"],
        )
        self.assertEqual(
            pointer["last_verified_machine_gates"],
            [
                "Windows Demo Export PASS · 2026-09-01 KST · GitHub Actions run 33415291733 · "
                "exact SX-DEC-069 source 79323ff0175b674c594d18dfd6d28a8e9951f5bd"
            ],
        )
        self.assertEqual(
            pointer["mint_after"],
    ...
    def test_current_machine_primary_surfaces_route_only_candidate_010_after_sx_dec_069(self) -> None:
        ...
        for relative in current_surfaces:
            text = (ROOT / relative).read_text(encoding="utf-8")
            self.assertIn("SX-DEC-069", text, relative)
            self.assertIn("SX60-POC-ACCEPT-010", text, relative)
