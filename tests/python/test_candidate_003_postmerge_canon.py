...
class Candidate003PostmergeCanonTests(unittest.TestCase):
    ...
    def test_active_context_preserves_003_evidence_without_current_promotion(self) -> None:
        ...
        for required in (
            ...
            "post_sx_dec_060_candidate: SX60-POC-ACCEPT-010 · PREPARED_PACKAGE_VERIFIED",
    ...
    def test_decision_owner_retains_historical_evidence_and_current_span(self) -> None:
        ...
        for required in (
            ...
            "sx_dec_060_post_change_candidate: SX60-POC-ACCEPT-010 · PREPARED_PACKAGE_VERIFIED",
    ...
    def test_candidate_003_has_no_post_060_current_pointer_or_launcher_route(self) -> None:
        ...
        self.assertIn('\"current_candidate_id\": \"SX60-POC-ACCEPT-010\"', pointer)
        self.assertIn('POST_SX_DEC_069_TRANSPARENT_WAYSIDE_SPEED_TRANSITION_PRODUCT_BYTES', pointer)
