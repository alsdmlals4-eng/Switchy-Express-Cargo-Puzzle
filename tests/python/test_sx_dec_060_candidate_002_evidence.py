...
class SXDec060Candidate002EvidenceTests(unittest.TestCase):
    ...
    def test_current_decisions_preserve_startup_only_evidence_without_physical_promotion(self) -> None:
        ...
        self.assertIn(
            "acceptance_build: SX60-POC-ACCEPT-010 · PREPARED_PACKAGE_VERIFIED · exact post-SX-DEC-069 transparent-wayside/speed-transition machine package · NO_HUMAN_OR_PHYSICAL_EVIDENCE",
            text,
        )
    ...
    def test_active_context_preserves_candidate_history_and_routes_to_new_machine_candidate(self) -> None:
        ...
        self.assertIn(
            "post_sx_dec_060_candidate_status: SX60-POC-ACCEPT-010 · PREPARED_PACKAGE_VERIFIED · SX60-POC-ACCEPT-009_historical",
            text,
        )
