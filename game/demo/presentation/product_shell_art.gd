...
const SCENE_SPECS := {
	"TITLE": {
		...
		"layers": [
			...
			{"key": "cargo_blue", "cell": Vector2i(4, 2), "role": "CARGO_ON_RAIL", "scale": CARGO_TARGET_SCALE},
	...
	"LESSON": {
		...
		"layers": [
			{"key": "rail_straight", "cell": Vector2i(0, 1), "role": "RAIL"},
			{"key": "rail_straight", "cell": Vector2i(1, 1), "role": "RAIL"},
			{"key": "rail_straight", "cell": Vector2i(2, 1), "role": "RAIL"},
			{"key": "rail_straight", "cell": Vector2i(3, 1), "role": "RAIL"},
			{"key": "rail_straight", "cell": Vector2i(4, 1), "role": "RAIL"},
			{"key": "cargo_blue", "cell": Vector2i(1, 1), "role": "CARGO_ON_RAIL", "scale": CARGO_TARGET_SCALE},
			{"key": "station_blue", "cell": Vector2i(3, 0), "role": "STATION", "scale": 0.88},
			{"key": "decoration_waterway", "cell": Vector2i(5, 1), "role": "DECOR", "scale": 0.62},
		],
	},
	"LESSON_T2": {
		"grid_size": Vector2i(6, 2),
		"layers": [
			...
			{"key": "rail_straight", "cell": Vector2i(3, 1), "role": "RAIL"},
			{"key": "rail_straight", "cell": Vector2i(4, 1), "role": "RAIL"},
			{"key": "cargo_red", "cell": Vector2i(1, 1), "role": "CARGO_ON_RAIL", "scale": CARGO_TARGET_SCALE},
			{"key": "station_red", "cell": Vector2i(2, 0), "role": "STATION", "scale": 0.88},
			{"key": "decoration_waterway", "cell": Vector2i(5, 1), "role": "DECOR", "scale": 0.62},
		],
	},
	"RESULT_SUCCESS": {
		...
		"layers": [
			...
			{"key": "rail_straight", "cell": Vector2i(4, 1), "role": "RAIL"},
			{"key": "cargo_blue", "cell": Vector2i(1, 1), "role": "CARGO_ON_RAIL", "scale": CARGO_TARGET_SCALE},
			{"key": "train", "cell": Vector2i(3, 1), "role": "TRAIN", "scale": 0.92},
			{"key": "station_blue", "cell": Vector2i(4, 0), "role": "STATION", "scale": 0.88},
			{"key": "decoration_timber_stack", "cell": Vector2i(5, 1), "role": "DECOR", "scale": 0.56},
		],
	},
	"RESULT_FAILURE": {
		"grid_size": Vector2i(6, 2),
		"layers": [
			...
			{"key": "rail_straight", "cell": Vector2i(3, 1), "role": "RAIL"},
			{"key": "rail_straight", "cell": Vector2i(4, 1), "role": "RAIL"},
			{"key": "cargo_waste", "cell": Vector2i(1, 1), "role": "CARGO_ON_RAIL", "scale": CARGO_TARGET_SCALE},
			{"key": "train", "cell": Vector2i(3, 1), "role": "TRAIN", "scale": 0.92},
			{"key": "station_disposal", "cell": Vector2i(4, 0), "role": "STATION", "scale": 0.88},
			{"key": "decoration_moss_boulder", "cell": Vector2i(5, 1), "role": "DECOR", "scale": 0.54},
		],
	},
}
