...
POST-060 EXACT CANDIDATE: SX60-POC-ACCEPT-005 · PREPARED_PACKAGE_VERIFIED · MACHINE_PRIMARY_ACCEPTANCE_READY · source main a11dfd1a063e434ee22e8cfb7b073ebc380aa27a
...
FINAL USER REVIEW: OPTIONAL_ONLY_WHEN_REQUESTED · NOT_RUN · EXACT_CANDIDATE_005_REQUIRED
...
```text
SX60-POC-ACCEPT-005 machine-primary package verification PASS
...
→ final user review is optional, only when requested, on unchanged exact Candidate 005 bytes
→ product decision
```
