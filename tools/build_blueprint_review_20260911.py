...
for title,path,caption in [
 ('운행 HUD · 선택 언어와 실제 수치','evidence/runtime/route-result-20260913/en-running.png','실제 RB08 운행 상단: 상태·남은 시간·미배송 수량·비용·메뉴를 영어로 표시한다. 다른 HUD 영역의 한국어는 후속 범위이며 전체 번역 완료를 뜻하지 않는다.'),
