...
| 2026-08-31 | SX-DEC-067 changed player-facing bytes after Route Book 01. Candidate 006 is retained as historical evidence; Candidate 007 binds the exact post-change machine package from `main@c0bb86efa5bad6050217ca67dd6aa9eba155dc75` with final user review still `NOT_RUN`. |
