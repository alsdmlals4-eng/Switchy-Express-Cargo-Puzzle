...
- A translucent left reading deck owns the title, Korean promise, first-session cue, and existing `StartButton`.
...
- The visual field must remain readable at 960×540, 1280×720, and 1920×1080; no text is baked into images.
