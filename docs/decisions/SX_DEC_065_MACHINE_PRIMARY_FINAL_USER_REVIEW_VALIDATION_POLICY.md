...
| 3. Exact-candidate eligibility | Can Candidate 004 be launched as the current v04 final-review candidate? | At policy adoption, the finding was corrected by setting the pointer to `NOT_CREATED`, preserving Candidate 004 as immutable pre-v04 evidence, and fail-closing the launcher. Candidate 005 was subsequently minted from exact `main@a11dfd1a063e434ee22e8cfb7b073ebc380aa27a`; its machine evidence is recorded separately and its final user review remains `NOT_RUN`. |
