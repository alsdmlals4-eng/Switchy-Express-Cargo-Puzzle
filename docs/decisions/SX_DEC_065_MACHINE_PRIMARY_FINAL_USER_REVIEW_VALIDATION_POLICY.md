...
| 3. Exact-candidate eligibility | Can a prior package candidate be launched as the current final-review candidate? | At policy adoption, the finding was corrected by setting the pointer to `NOT_CREATED`, preserving prior candidates as immutable evidence, and fail-closing the launcher. Candidate 006 was subsequently minted after Route Book 01; SX-DEC-067 then changed player-facing bytes and Candidate 007 bound those exact bytes. SX-DEC-068 then changed the title shell, so Candidate 007 is historical and Candidate 008 bound exact `main@53e29f874bc70a0057c310d661dc45dbecc6cf13`. The user subsequently approved the wordmark pixels and their manifest promotion, making Candidate 008 historical pre-canonical-status evidence; Candidate 009 bound exact source `1ac3099d9ab1451323cca2935547f82d210b50b4`. SX-DEC-069 then changed transparent wayside/speed-transition bytes, so Candidate 009 is historical and Candidate 010 binds exact `main@79323ff0175b674c594d18dfd6d28a8e9951f5bd`. Only Candidate 010 is final-user-review eligible while unchanged; wordmark pixel approval is complete and v02 wayside pixel review remains pending. |
