...
| 3. Exact-candidate eligibility | Can a prior package candidate be launched as the current final-review candidate? | At policy adoption, the finding was corrected by setting the pointer to `NOT_CREATED`, preserving prior candidates as immutable evidence, and fail-closing the launcher. Candidate 006 was subsequently minted after Route Book 01 from exact `main@9af5a8c46d29ea6781f9ee06008d7c7d2cde1877`; SX-DEC-067 later changed player-facing bytes, so Candidate 006 is historical. Candidate 007 now binds the exact `main@c0bb86efa5bad6050217ca67dd6aa9eba155dc75` package and is the only final-user-review-eligible candidate while unchanged. |
