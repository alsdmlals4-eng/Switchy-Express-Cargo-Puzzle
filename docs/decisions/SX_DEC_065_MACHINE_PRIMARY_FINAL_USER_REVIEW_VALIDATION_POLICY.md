...
| 3. Exact-candidate eligibility | Can Candidate 004 be launched as the current v04 final-review candidate? | Finding corrected. The post-060 pointer now reports `NOT_CREATED`, has no current candidate id, preserves Candidate 004 as immutable pre-v04 evidence, and fail-closes the launcher until Candidate 005 is minted. |
