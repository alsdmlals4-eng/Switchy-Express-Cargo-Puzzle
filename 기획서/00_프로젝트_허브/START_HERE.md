...
| post-060 candidate route | `evidence/acceptance/post_sx_dec_060_candidate.json · SX60-POC-ACCEPT-009 is the exact post-SX-DEC-068 canonical-wordmark machine package · Candidates 001–008 are historical · FINAL_USER_REVIEW_NOT_RUN · TITLE_WORDMARK_USER_PIXEL_APPROVED_CANON_REGISTERED` |
...
| post-060 Windows physical | `FINAL_USER_REVIEW_ONLY · unchanged SX60-POC-ACCEPT-009 required · NOT_RUN` |
...
Do not run its old physical Gate 0 as if it validated the new rule. `SX60-POC-ACCEPT-006` is historical Route Book 01 evidence, `SX60-POC-ACCEPT-007` is historical post-SX-DEC-067 evidence, and Candidate 008 is historical pre-canonical-wordmark-status evidence; `SX60-POC-ACCEPT-009` is the exact post-SX-DEC-068 canonical-wordmark machine-primary package and remains exact-byte-specific.
...
→ SX-DEC-068 changed player-facing title-shell bytes; Candidate 008 remains historical pre-canonical-wordmark-status evidence, while Candidate 009 binds the exact current package and Candidates 006–007 stay historical
→ FINAL_USER_REVIEW only if the user requests final inspection of unchanged Candidate 009 bytes; title wordmark pixel approval and canonical registration are complete
