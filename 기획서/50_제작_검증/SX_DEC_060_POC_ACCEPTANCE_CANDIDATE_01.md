...
Status: `PREPARED_PACKAGE_VERIFIED · PHYSICAL_EVIDENCE_NOT_RUN`
...
Candidate 003 remains historical pre-060 evidence only. This candidate is the sole explicit post-060 package route. The launcher redownloaded and rechecked the pinned package with `-NoLaunch`; that is package evidence only, not physical or human validation.
